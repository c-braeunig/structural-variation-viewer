...
class Application(tk.Frame):
    ...
    def initUI(self):
        ...
        self.draw_pane=ttk.Labelframe(self.p,text='',
                                      width=50,height=75,labelanchor='n')
    ...
    def heat_menu(self):
        ...
        self.heat_entry=tk.Entry(self.parameter_pane,state=tk.DISABLED,
                                 textvariable=self.heat_var,width=10)
        self.heat_var.set(0)
        ...
        self.heat_checkButton.grid(row=3,column=0,
                                   #padx=3,
                                   #pady=0,
                                   sticky='w')
    ...
    def type_menu(self):
        ...
        self.VerboseButton=tk.Checkbutton(self.parameter_pane,text='Complement selection',
                                          variable=self.typeVerbose)
        self.VerboseButton.grid(row=0,column=1,columnspan=2)
    ...
    def anno_check(self):
        ...
        self.anno_checkButton=tk.Checkbutton(self.annotation_pane,text='Draw annotations',
                                             var=self.anno_check)            
        self.anno_checkButton.grid(row=1,column=0,
                                   sticky='w')
    ...
    def anno_type_menu(self):
        ...
        self.a_VerboseButton=tk.Checkbutton(self.annotation_pane,text='Complement selection',
