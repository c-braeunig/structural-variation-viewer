...
if __name__ == "__main__":
   ...
   parser.add_argument('--sort',choices=['asc_size','des_size','type','type_asc_size','type_des_size','CR'],help='Provide sorting criterium to organize SVs; SVs sorted by position on chromosome/contig by default; no sorting recommended for downstream SVsee use; Use "CR" (chromomosomal rearrangement) when filtering by "BND" (complex rearrangement with breakends) to sort target locations')
