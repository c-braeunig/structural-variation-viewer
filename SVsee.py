...
if __name__ == "__main__":
   ...
   parser.add_argument('-RC','--anno_cont',type=str,nargs='+',help='Complementary type filter, selected type(s) will be excluded, multiple arguments given space-separated (only applicable on GFF annotation files)')
